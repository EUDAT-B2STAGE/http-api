...
To send any kind of requests to the B2STAGE HTTP-API an *authentication token*is needed: vist this the [Authentication documentation](#docs/user/authentication.md) for further details.
...
The complete description of the operation you can perform on B2SAFE is available in the [namespace api](#docs/user/registered.md) page.
